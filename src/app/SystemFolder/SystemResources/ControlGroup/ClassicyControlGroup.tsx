import classicyControlGroupStyles
    from "@/app/SystemFolder/SystemResources/ControlGroup/ClassicyControlGroup.module.scss";
...
const ClassicyControlGroup = ({label = "", columns = false, children}) => {
    return (
        <fieldset
            className={classNames(classicyControlGroupStyles.classicyControlGroup,
                columns ?
                    classicyControlGroupStyles.classicyControlGroupColumns :
                    classicyControlGroupStyles.classicyControlGroupNoColumns
            )}>
            {label !== "" &&
                <legend className={classicyControlGroupStyles.classicyControlGroupLegend}>{label}</legend>
            }
